    ...
    <form action="{{ route('admin.articles.update', $article->id) }}" method="POST">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" style="text-transform: uppercase;" name="title" class="form-control" id="title" value="{{ $article->title }}" required>
            </div>
...
p {
padding: 0 !important; /* Прибираємо вертикальні пробіли між абзацами */
}
...
<script>
  tinymce.init({
    ...
    language: 'uk',     
    height: 600,
    content_style: 'p { margin: 0 !important; } ul, ol { margin: 0  !important; }',
    promotion: false,
    branding: false,
    plugins: [
